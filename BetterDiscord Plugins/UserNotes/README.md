# User Notes - [![Download][download-badge]][download-link] [![Support][support-badge]][support-link] [![PayPal][paypal-badge]][paypal-link] [![Patreon][patreon-badge]][patreon-link]
...
[download-link]: https://mwittrien.github.io/downloader/?plugin=UserNotes
...
Modified by sleek(Me: S4dic) to save all data in a folder named "UserNotesSave", with a separate profile for each user.
